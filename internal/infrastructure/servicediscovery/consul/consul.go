...
import (
	...
	"github.com/go-park-mail-ru/2019_1_Escapade/internal/infrastructure/servicediscovery"
...
*/
type Consul struct {
	c *servicediscovery.Configuration
...
func New(
	...
	if loadBalancer == nil {
		loadBalancer = &infrastructure.LoadBalancerEmpty{}
	} else {
