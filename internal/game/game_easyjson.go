...
func easyjson85f0d656DecodeGithubComGoParkMailRu20191EscapadeInternalGame(in *jlexer.Lexer, out *ConnectionJSON) {
...
func easyjson85f0d656EncodeGithubComGoParkMailRu20191EscapadeInternalGame(out *jwriter.Writer, in ConnectionJSON) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson85f0d656DecodeGithubComGoParkMailRu20191EscapadeInternalGame1(in *jlexer.Lexer, out *LobbyJSON) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson85f0d656EncodeGithubComGoParkMailRu20191EscapadeInternalGame1(out *jwriter.Writer, in LobbyJSON) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson85f0d656DecodeGithubComGoParkMailRu20191EscapadeInternalGame3(in *jlexer.Lexer, out *RoomGet) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson85f0d656EncodeGithubComGoParkMailRu20191EscapadeInternalGame3(out *jwriter.Writer, in RoomGet) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson85f0d656DecodeGithubComGoParkMailRu20191EscapadeInternalGame4(in *jlexer.Lexer, out *RoomSend) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson85f0d656EncodeGithubComGoParkMailRu20191EscapadeInternalGame4(out *jwriter.Writer, in RoomSend) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Cell != nil {
...
func easyjson85f0d656DecodeGithubComGoParkMailRu20191EscapadeInternalGame6(in *jlexer.Lexer, out *RoomRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson85f0d656EncodeGithubComGoParkMailRu20191EscapadeInternalGame6(out *jwriter.Writer, in RoomRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson85f0d656DecodeGithubComGoParkMailRu20191EscapadeInternalGame7(in *jlexer.Lexer, out *RoomJSON) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson85f0d656EncodeGithubComGoParkMailRu20191EscapadeInternalGame7(out *jwriter.Writer, in RoomJSON) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson85f0d656DecodeGithubComGoParkMailRu20191EscapadeInternalGame13(in *jlexer.Lexer, out *ConnectionsJSON) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson85f0d656EncodeGithubComGoParkMailRu20191EscapadeInternalGame13(out *jwriter.Writer, in ConnectionsJSON) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	for !in.IsDelim('}') {
		...
		case "players":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v16 Player
					easyjson85f0d656DecodeGithubComGoParkMailRu20191EscapadeInternalGame15(in, &v16)
		...
		case "flags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Flags = append(out.Flags, v17)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	}
	{
		...
		if in.Players == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v18, v19 := range in.Players {
				...
				easyjson85f0d656EncodeGithubComGoParkMailRu20191EscapadeInternalGame15(out, v19)
			}
			out.RawByte(']')
		}
	}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson85f0d656DecodeGithubComGoParkMailRu20191EscapadeInternalGame5(in, v22)
					}
		...
		if in.History == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v23, v24 := range in.History {
				...
				if v24 == nil {
					...
					easyjson85f0d656EncodeGithubComGoParkMailRu20191EscapadeInternalGame5(out, *v24)
				}
			}
			out.RawByte(']')
		}
